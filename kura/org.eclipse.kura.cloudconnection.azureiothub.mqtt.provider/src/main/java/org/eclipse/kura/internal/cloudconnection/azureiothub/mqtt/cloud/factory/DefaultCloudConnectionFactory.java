 ...
 *     Red Hat Inc
 *******************************************************************************/
package org.eclipse.kura.internal.cloudconnection.azureiothub.mqtt.cloud.factory;
...
public class DefaultCloudConnectionFactory implements CloudConnectionFactory {
    ...
    private static final Pattern MANAGED_CLOUD_SERVICE_PID_PATTERN = Pattern.compile(
            "^org\\.eclipse\\.kura\\.cloudconnection\\.azureiothub\\.mqtt\\.ConnectionManager(-[a-zA-Z0-9]+)?$");
